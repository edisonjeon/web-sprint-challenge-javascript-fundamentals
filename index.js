...
// A: It's a rule of JavaScript, that nested functions are able to access the scope above them.
...
const zooAnimals = [
 ...
 function animalNames() {
  const displayNames = [];
  zooAnimals.forEach(function(animalObject){
    displayNames.push(`name: ${animalObject.animal_name}, scientific: ${animalObject.scientific_name}`)
 }) 
  return displayNames;
}
console.log(animalNames())
  ...
  */
  ...
  function lowPopulationAnimals(){
    let lowerPopulation = zooAnimals.filter(function(item){
  ...
  */
  ...
  function USApop(){
    let totalAmount = zooAnimals.reduce(function (accumulator, item) {
